...
<aside id="left-sidebar-nav">
	...
	<ul id="nav-mobile" class="side-nav fixed" style="transform: translateX(0%);">
        ...
        <li class="bold"><a href="about.html" class="waves-effect waves-teal">마테리얼라이즈에 대해서</a></li>
        <li class="bold"><a href="getting-started.html" class="waves-effect waves-teal">처음 시작하기</a></li>
        <li class="no-padding">
          <ul class="collapsible collapsible-accordion">
            <li class="bold"><a class="collapsible-header  waves-effect waves-teal">CSS</a>
              <div class="collapsible-body">
                <ul>
                  <li><a href="color.html">색상</a></li>
        ...
        <li class="bold active"><a href="free-reg" class="waves-effect waves-teal">글쓰기</a></li>
      </ul>
	<!--  -->
</aside>
